      ...
      <div className="weather-container centered">
        {weatherData && (
          <div className="weather-card centered">
            ...
            <p className="temp">
              {" "}
              <img src={temp} alt="" /> {weatherData.main.temp}°C
            </p>
            <p className="feel">Feels like: {weatherData.main.feels_like}°C</p>
            <p className="min">
              temp_min <img src={temp_min} alt="" />
              {weatherData.main.temp_min}°C
            </p>
            <p className="max">
              temp_max <img src={temp_max} alt="" />
              {weatherData.main.temp_max}°C
            </p>
            <p className="pressure">
              pressure
              <img src={pressure} alt="" /> {weatherData.main.pressure} hPa
            </p>
            <p className="humid">
              humidity <img src={humidity} alt="" /> {weatherData.main.humidity}
              %
            </p>
            <p className="wind_speed">
              wind_speed <img src={speed} alt="" /> {weatherData.wind.speed} m/s
            </p>
            <p className="wind_dir">
              wind_direction <img src={direction} alt="" />
